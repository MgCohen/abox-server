...
// Recipe slots are typed against these, so composition is checked at authoring time:
// an IExpr<int> slot rejects anything that isn't an int producer.
interface IStmt;
...
// A sequence of statements. Doubles as the recipe root and as a body-slot filler.
