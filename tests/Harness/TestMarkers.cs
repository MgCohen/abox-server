...
// subclassing FactAttribute, so a foreign marker joins by adding a name (rationale: commit 8637024). [ParityFact]
// is absent on purpose: the lone parity fact is citation-exempt.
