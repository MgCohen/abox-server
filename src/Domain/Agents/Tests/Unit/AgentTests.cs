...
public class AgentTests
{
    ...
    {
        var agent = new FakeAgentFactory().Create(DomainAgents.Implementer, "C:/proj");
    ...
    {
        var agent = new Agent(new FakeProvider(DomainAgents.Reviewer), new NonInteractiveResolver(), null, "C:/proj");
