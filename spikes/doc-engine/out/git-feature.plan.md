...
| 1 |  | summary |  |  |
| 2 |  | context |  |  |
| 3 | Scope | scope | In scope |  |
| 4 | Scope | scope | Out of scope |  |
| 5 | Decisions | decision | Canonical feature shape (ADR 0011) |  |
| 6 | Decisions | decision | Merge-commit for Level-1 |  |
| 7 | Decisions | decision | Never key state on a SHA |  |
| 8 | Decisions | decision | Read-as-bot |  |
| 9 | Decisions | decision | Force-push lean |  |
| 10 | Phases | phase | Spikes: retire the unknowns | done |
| 11 | Phases | phase | Canonical framework port (stub stays, parity-gated) | done |
| 12 | Phases | phase | Real GitHub adapter | blocked |
| 13 | Phases | phase | Stack system (IStackHost) | todo |
| 14 |  | verification |  |  |
| 15 | Open Questions | open-question | GitHub client library |  |
| 16 | Open Questions | open-question | Spike/adapter target repo |  |
| 17 | Open Questions | open-question | Level-2 merge method |  |
<!-- INDEX:END -->
