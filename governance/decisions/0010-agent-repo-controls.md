...
[`governance/README.md`](../README.md), which this ADR does not
restate.
...
[`governance/README.md`](../README.md) so they cannot silently slip.
...
- How-to + deferred steps: [`governance/README.md`](../README.md)
