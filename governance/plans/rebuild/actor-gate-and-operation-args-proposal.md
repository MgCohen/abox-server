...
- **Scope:** the rebuild (`/src`) run contract, the actor/operation model, and the
  Flow execution gate.
- **Refines / supersedes:** [ADR 0003](../../decisions/0003-actors-operations-run-contract.md)
  (un-fuses actor from operation — **re-fused here**), [ADR 0004](../../decisions/0004-provider-seam.md)
  (provider seam — **stands**), [ADR 0005](../../decisions/0005-operation-args-generic.md)
