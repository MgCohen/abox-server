...
What the engine is made of, in the [ADR 0002](../../decisions/0002-tools-steps-flows.md)
vocabulary: **Tools** (intent-free capabilities), **Actors** (intent + identity
that mint **Operations**, [ADR 0003](../../decisions/0003-actors-operations-run-contract.md)),
...
[ADR 0004](../../decisions/0004-provider-seam.md)) and mints the agent run as an
